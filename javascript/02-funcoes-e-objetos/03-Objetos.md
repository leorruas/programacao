...
*   **Objetos Embutidos:** O [[javascript/Introdução ao JavaScript\|JavaScript]] possui objetos nativos pré-configurados, como [[javascript/03-manipulacao/06-Math\|Math]] para [[javascript/02-funcoes-e-objetos/01-Funções\|Funções]] matemáticas e [[javascript/Consumindo APIs e Fetch\|JSON]] para estruturação de dados.
