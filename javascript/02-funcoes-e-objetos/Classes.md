...
Uma classe é simplesmente uma receita, molde ou gabarito estruturado para criar [[javascript/01-fundamentos/Objetos\|Objetos]].
...
*   **Os Métodos (As Ações do [[javascript/01-fundamentos/Protótipos e Proto\|Protótipos e Proto]]):** São as [[javascript/01-fundamentos/Funções\|Funções]] que o botão sabe executar. No Figma, seriam as regras de transição (ex: hover para mudar de cor, ou clique para mudar de tela).
...
Assim como nas [[javascript/01-fundamentos/Funções Construtoras\|Funções Construtoras]], usamos a palavra-chave `new` para criar cópias independentes a partir da nossa classe:
...
*   **Açúcar Sintático (Syntactic Sugar):** A palavra `class` é apenas uma forma mais bonita, limpa e moderna de escrever o que antes era feito com [[javascript/01-fundamentos/Funções Construtoras\|Funções Construtoras]] tradicionais.
*   **Organização:** Nas [[javascript/01-fundamentos/Funções\|Funções]] construtoras, os métodos muitas vezes eram adicionados do lado de fora da [[javascript/01-fundamentos/Funções\|Funções]] usando [[javascript/01-fundamentos/Protótipos e Proto\|Protótipos e Proto]] (`Funcao.prototype.metodo = ...`). Com as classes, tudo fica contido dentro do mesmo par de chaves `{}`.
...
*   **Método:** Uma [[javascript/01-fundamentos/Funções\|Funções]] que pertence àquela classe e descreve o que os [[javascript/01-fundamentos/Objetos\|Objetos]] criados por ela podem fazer.
