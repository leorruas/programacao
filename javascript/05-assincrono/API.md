...
As APIs na web costumam funcionar por meio de requisições HTTP enviando e recebendo dados em formato [[javascript/01-fundamentos/JSON]] (usando ferramentas como o [[javascript/01-fundamentos/Fetch]] para buscar e processar as informações). 
