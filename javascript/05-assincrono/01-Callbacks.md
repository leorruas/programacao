...
No [[javascript/Introdução ao JavaScript\|JavaScript]], muitas tarefas levam tempo para terminar (como ler um arquivo, carregar uma imagem ou buscar dados de uma [[csharp/25-Consumindo APIs em Csharp\|API]]). Se o código parasse tudo para esperar essas tarefas, a página iria travar. 
...
3. **[[javascript/03-manipulacao/02-Arrays e métodos de array\|Métodos de Array]]:**
   ```javascript
