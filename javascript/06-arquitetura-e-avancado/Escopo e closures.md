...
Em [[javascript/Introdução ao JavaScript\|JavaScript]], onde e como você cria suas variáveis define quem pode ter acesso a elas. As regras de declaração com `var`, `let` e `const` explicadas em [[javascript/01-fundamentos/Var, Let e Const]] são a base disso.
