...
Conforme o seu projeto web cresce, colocar todo o código [[javascript/Introdução ao JavaScript\|JavaScript]] dentro de um único arquivo gigante se torna inviável. Módulos são a solução para dividir o seu código em arquivos menores, organizados e especializados, onde exportamos e importamos [[javascript/01-fundamentos/Funções\|funções]] e [[javascript/01-fundamentos/Classes\|classes]] (um padrão essencial ao migrar para [[javascript/06-arquitetura-e-avancado/TypeScript introdução]]).
...
Imagine um arquivo chamado `botoes.js` contendo [[javascript/01-fundamentos/Funções\|Funções]] de estilo para botões:
...
*   **Reutilização:** Você pode importar a mesma [[javascript/01-fundamentos/Funções\|Funções]] de botão em dez telas diferentes sem precisar duplicar o código.
...
*   **Export:** A palavra-chave usada no arquivo de origem para permitir que [[javascript/01-fundamentos/Funções\|Funções]], [[javascript/01-fundamentos/Objetos\|Objetos]] ou variáveis sejam usados por outros arquivos.
*   **Import:** A palavra-chave usada no arquivo de destino para trazer as [[javascript/01-fundamentos/Funções\|Funções]] ou variáveis exportadas de outro módulo.
