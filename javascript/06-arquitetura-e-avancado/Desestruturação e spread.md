...
No [[javascript/Introdução ao JavaScript\|JavaScript]] moderno (ES6+), existem atalhos de escrita criados para facilitar a extração de dados e a cópia de [[javascript/02-funcoes-e-objetos/Objetos|Objetos]] ou arrays (que vimos em [[javascript/01-fundamentos/Tipos de dados|Tipos de dados]]). 
...
No [[javascript/Introdução ao JavaScript\|JavaScript]], a desestruturação permite extrair valores de dentro de [[javascript/01-fundamentos/Objetos\|Objetos]] ou arrays e salvá-los diretamente em variáveis individuais, sem precisar digitar o nome do [[javascript/01-fundamentos/Objetos\|Objetos]] várias vezes.
...
O operador **Spread** (representado por três pontos: `...`) serve para espalhar ou "despejar" as propriedades de um [[javascript/01-fundamentos/Objetos\|Objetos]] ou array dentro de outro. Isso permite copiar dados e criar novos [[javascript/01-fundamentos/Objetos\|Objetos]] alterando apenas o necessário.
...
*   **Desestruturação:** Atalho para extrair valores de dentro de [[javascript/01-fundamentos/Objetos\|Objetos]] ou arrays diretamente para variáveis isoladas usando `{}` ou `[]`.
*   **Operador Spread (`...`):** Copia (espalha) o conteúdo de uma lista ou [[javascript/01-fundamentos/Objetos\|Objetos]] existente para dentro de um novo elemento, permitindo criar cópias e alterar dados com facilidade.
