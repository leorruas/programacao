...
Podemos enviar qualquer [[javascript/01-fundamentos/03-Tipos de dados\|tipo de dado]] para ser impresso no console: textos, números, variáveis ou até mesmo [[javascript/02-funções-e-objetos/03-Objetos\|Objetos]] complexos.
...
*   **`console.log()`:** Uma [[javascript/02-funções-e-objetos/01-Funções\|Funções]] de telemetria para exibir dados no painel de desenvolvimento (console).
