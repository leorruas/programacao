...
*   O `switch` recebe avaliações baseadas nos operadores de igualdade estrita (`===`) detalhados em **[[javascript/01-fundamentos/Operadores e Operações]]**.
*   Ele é a estrutura ideal para gerenciar modificações de estados simples, frequentemente chamados por **[[javascript/01-fundamentos/Eventos]]** na tela.
