...
*   **O `!!` altera o dado na memória:** É o ato de arquivar uma **ficha padronizada oficial escrito apenas "true" ou "false"** no banco de dados. Banco de dados e [[csharp/25-Consumindo APIs em Csharp\|API]] frequentemente rejeitam salvar textos ou números soltos em colunas booleanas de sim/não; eles exigem estritamente um valor booleano puro. O `!!` garante que o dado seja convertido de verdade na memória antes de ser salvo ou enviado.
