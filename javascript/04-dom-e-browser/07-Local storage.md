...
O funcionamento do Local Storage é baseado em chave e valor, de forma muito semelhante a um dicionário de dados ([[javascript/03-manipulacao/08-JSON\|JSON]], explicado em [[javascript/03-manipulacao/08-JSON|JSON]]). Ele armazena apenas dados em formato de **texto (string)**.
