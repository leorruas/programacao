...
O funcionamento do Local Storage é baseado em chave e valor, de forma muito semelhante a um dicionário de dados ([[javascript/01-fundamentos/JSON\|JSON]], explicado em [[javascript/01-fundamentos/JSON]]). Ele armazena apenas dados em formato de **texto (string)**.
...
O Local Storage só aceita textos simples. Se você tentar salvar um [[javascript/01-fundamentos/Objetos\|Objetos]] complexo (como as propriedades de um [[javascript/01-fundamentos/Objetos\|objeto]] ou array), o navegador vai salvar como `"[object Object]"`, estragando os dados.

Para salvar [[javascript/01-fundamentos/Objetos\|Objetos]] ou arrays no Local Storage, precisamos transformá-los em texto usando o **[[javascript/01-fundamentos/JSON\|JSON]]** antes de salvar, e convertê-los de volta para [[javascript/01-fundamentos/Objetos\|Objetos]] na hora de ler:
...
*   **Armazenamento em texto:** Guarda apenas strings. Use `JSON.stringify` para salvar [[javascript/01-fundamentos/Objetos\|Objetos]] e `JSON.parse` para convertê-los de volta.
