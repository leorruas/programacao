...
Para entender de forma simples: o JSON é a **Ficha de Cadastro Universal** da internet, baseado na estrutura de [[javascript/02-funcoes-e-objetos/03-Objetos|Objetos]] do [[javascript/Introdução ao JavaScript\|JavaScript]]. Ele é o formato de texto padrão usado para transmitir dados entre computadores e consultar dados de uma [[csharp/25-Consumindo APIs em Csharp|API]] usando o [[javascript/05-assincrono/03-Fetch|Fetch]].
