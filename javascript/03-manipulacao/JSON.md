...
Para entender de forma simples: o JSON é a **Ficha de Cadastro Universal** da internet, baseado na estrutura de [[javascript/01-fundamentos/Objetos]] do [[javascript/Introdução ao JavaScript\|JavaScript]]. Ele é o formato de texto padrão usado para transmitir dados entre computadores e consultar dados de uma [[javascript/01-fundamentos/API]] usando o [[javascript/01-fundamentos/Fetch]].
