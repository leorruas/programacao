...
Até agora, vimos os [Arrays](Arrays.md), que servem para guardar uma lista de itens. Mas os arrays têm um problema: eles são como gaveteiros de madeira rígidos. Se você construiu um com 5 gavetas, terá 5 gavetas para sempre. Se precisar de uma sexta, terá que construir um armário novo do zero.
...
* **[Guia de estudos de C#](Guia%20de%20estudos.md)**
