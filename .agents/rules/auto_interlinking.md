...
4. **Alvos Limpos:** Use sempre o nome exato do arquivo no Wikilink (ex: `[[csharp/12-Arrays em Csharp|arrays]]` em vez de `[[csharp/12-Arrays em Csharp|arrays]]` se o arquivo físico começar com o prefixo numérico).
